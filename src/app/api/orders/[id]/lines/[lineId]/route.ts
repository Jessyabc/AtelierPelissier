...
const updateSchema = z.object({
  ...
  // Alias used by the receive-action UI
...
/**
 * PATCH: Update an order line (primarily to record receipts). Admin/planner only.
 * Receiving is a stock-moving action — we intentionally restrict it to roles that
